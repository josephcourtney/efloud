...
## 1. Add stable producer identity and lifecycle semantics
...
## 2. Add deterministic derivation identity and reuse
...
## 3. Migrate persistent semantic indexes onto derivation semantics
...
## 4. Run and repair the Phase 6-8 quality gate
